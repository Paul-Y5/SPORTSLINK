  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        preferredSize: const Size.fromHeight(100), // Define uma altura menor para a AppBar
        // AppBar personalizada
        child: AppBar(
          backgroundColor: Colors.transparent, // Deixa o AppBar transparente
          elevation: 0, // Remove a sombra do AppBar
          flexibleSpace: Padding(
            padding: const EdgeInsets.only(top: 50.0), // Ajusta o espaçamento para baixo
            child: Image.asset(
